...
export const siteConfig = {
  ...
  tagline:`After searching for a career path that would challenge me and push me to grow, I found myself drawn to identity, access, and the systems that quietly power the cloud.
